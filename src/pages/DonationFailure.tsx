        ...
        <div className="max-w-md w-full bg-card p-8 rounded-lg shadow-lg">
          {loading ? (
            ...
            <div className="text-center">
              ...
              <h1 className="text-2xl font-bold mb-2">Donación no completada</h1>
              <p className="text-muted-foreground mb-6">
                Lo sentimos, hubo un problema al procesar tu donación. No se ha realizado 
              ...
              <div className="flex flex-col gap-2">
                ...
                <Link to="/projects">
                  <Button variant="default" className="w-full">Intentar de nuevo</Button>
                </Link>
                <Link to="/">

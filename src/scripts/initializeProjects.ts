...
const DEMO_PROJECTS: Project[] = [
  {
    id: 'project_demo_1',
    title: 'Ayuda para Comedor Comunitario',
    shortDescription: 'Juntar fondos para mejorar la infraestructura del comedor comunitario en Villa Soldati.',
    fullDescription: 'El comedor comunitario atiende diariamente a más de 200 niños y adultos mayores en situación de vulnerabilidad. Necesitamos renovar la cocina y el espacio de comedor para brindar un mejor servicio. Con tu ayuda podremos comprar nuevos electrodomésticos, mesas, sillas y realizar reparaciones urgentes en la instalación eléctrica y de gas.',
    goalAmount: 500000,
    amountRaised: 320000,
    coverImage: 'https://images.unsplash.com/photo-1559027615-cd4628902d4a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80',
    isActive: true,
  ...
  },
  {
    ...
    fullDescription: 'Queremos establecer un espacio de lectura y aprendizaje en uno de los barrios más vulnerables. El proyecto incluye la compra de libros, mobiliario, computadoras y la capacitación de voluntarios para gestionar el espacio. La biblioteca ofrecerá apoyo escolar, talleres de lectura y actividades culturales para toda la comunidad.',
    goalAmount: 350000,
    amountRaised: 115000,
    coverImage: 'https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80',
    isActive: true,
  ...
  },
  {
    ...
    shortDescription: 'Recaudar fondos para equipos médicos especializados para el Hospital de Niños.',
    fullDescription: 'El Hospital de Niños necesita renovar urgentemente equipamiento médico en la unidad de cuidados intensivos. Con esta campaña buscamos adquirir monitores multiparamétricos, respiradores y bombas de infusión para mejorar la atención de los niños en estado crítico. Cada donación, por pequeña que sea, nos acerca más a este objetivo que salvará vidas.',
    goalAmount: 1200000,
    amountRaised: 780000,
    coverImage: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80',
    isActive: true,
